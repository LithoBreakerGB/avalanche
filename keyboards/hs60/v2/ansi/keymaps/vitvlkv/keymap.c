...
[0] = LAYOUT_60_ansi( /* Base */
    ...
    KC_LCTL,  KC_LGUI,  KC_LALT,                                KC_SPC,                                 MO(1),    KC_RALT,  LT(2, KC_APP),  KC_GRV),

// KC_SLCK,  KC_PAUS,
[1] = LAYOUT_60_ansi( /* Fn */
    KC_GRV,   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,         KC_DEL,\
    _______,  KC_PGUP,  _______,  _______,  _______,  _______,  _______,  _______,  KC_INS,   KC_HOME,  KC_UP,    KC_END,   _______,        _______,\
    _______,  KC_PGDN,  KC_PSCR,  KC_HOME,  KC_END,   KC_DEL,   _______,  _______,  KC_BSPC,  KC_LEFT,  KC_DOWN,  KC_RGHT,                  _______,\
